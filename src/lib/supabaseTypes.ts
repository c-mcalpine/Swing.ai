    ...
    Tables: {
      ...
      practice_session: {
        Row: {
          ...
          grade_color: string | null;  // "primary", "yellow", etc.
      ...
      user_lesson_progress: {
        Row: {
          ...
          status: string | null;            // 'in_progress' | 'completed' | 'paused'
          last_practiced_at: string | null; // timestamptz
          due_at: string | null;            // timestamptz
          retention_score: number | null;   // 0–1 or 0–100
          created_at: string;
          updated_at: string;
        };
        Insert: {
      ...
      user_review_event: {
        Row: {
          ...
          title: string;
          description: string | null;
          icon: string | null;        // 'sports_golf', 'show_chart', etc.
          color: string | null;       // 'blue', 'orange', 'primary', ...
      ...
      user_drill_assignment: {
        Row: {
          ...
          user_id: string;
          drill_id: number;
          status: string | null;            // 'active' | 'mastered' | 'paused'
          due_at: string | null;            // timestamptz
          last_practiced_at: string | null; // timestamptz
          is_active: boolean | null;
          sort_order: number | null;
